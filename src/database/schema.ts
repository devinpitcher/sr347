...
export const trafficTable = sqliteTable(
  "traffic",
  {
    ...
    inboundTypicalDuration: integer({ mode: "number" }).default(0),
    inboundDurationInTraffic: integer({ mode: "number" }).notNull(),
    inboundTypicalDurationInTraffic: integer({ mode: "number" }).default(0),
    outboundDuration: integer({ mode: "number" }).notNull(),
    outboundTypicalDuration: integer({ mode: "number" }).default(0),
    outboundDurationInTraffic: integer({ mode: "number" }).notNull(),
    outboundTypicalDurationInTraffic: integer({ mode: "number" }).default(0),
    dayOfWeek: integer({ mode: "number" }).default(0).notNull(),
    timeOfDay: integer({ mode: "number" }).default(0).notNull(),
