...
import { trackPage } from "~/lib/umami";
      ...
      <section>
        <div className="relative bg-slate-100 dark:bg-slate-950">
          <div className="relative h-80 overflow-hidden bg-slate-600 md:absolute md:left-0 md:h-full md:w-1/3 lg:w-1/2">
            <img src="https://cdn.sr347.com/347-accident.jpg" className="size-full object-cover mix-blend-overlay grayscale" alt="Car accident on SR347" />
          </div>
